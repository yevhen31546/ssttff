...
export class SubscriptionPlansComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    console.log("current localstorage check", this.localStorage);
  ...
  public ngAfterViewInit() {
    this.stripeCheckoutLoader
      ...
      .then((handler: StripeCheckoutHandler) => {
        ...
        console.log(
          "selected_plan localstorage value is here",
    ...
    if (type != "basic") {
      this.stripeCheckoutHandler
        .open({
          ...
          closed: function() {
            console.log(
              this.localStorage.hasOwnProperty("selected_plan"),
              "is selected_plan"
            );
            if (this.localStorage.getItem("selected_plan") !== null) {
              this.localStorage.removeItem("selected_plan");
            }
          }
        })
  ...
  upgradePayment(data) {
    //console.log("upgrafeeee")
    console.log("upgrade Payment param", data);
    this.loaderservice.display();
  ...
  redirect(type, interval, price) {
    console.log("selected_plan is here", localStorage.getItem("selected_plan"));
